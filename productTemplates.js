module.exports = {
  ...
  ·٠•● Contesta y realiza llamadas
  ·٠•● Controla canciones (compatible con audífonos Bluetooth)
  ·٠•● Medidor pulso cardíaco, oxímetro, presión sanguínea y respiración
  ·٠•● Carga Magnética
  ──────────────────
  Características TÉCNICAS📲
  ·٠•● Batería de 200 mAh (Dura 5-6 dias)
  ·٠•● Manillas de silicona suave
  ·٠•● Pantalla Touch de Alta Definición 240*240 (super nítido )
  ·٠•● Pantalla de 1.39 pulgadas
  ·٠•● Hasta 60 fondos de pantalla
  ·٠•● A prueba de sudor y salpicaduras IP67 (sumergible por media hora)
  ──────────────────
  Disponibilidad 🎨
  ...
  *Principales características*
  ...
  - Micrófono interno para contestar llamadas
  - Volumen potente
  - 4 modos de iluminación (incluye modo que reacciona con la música)
  ──────────────
  *Características técnicas*
...
Precio en combo Bs. 329`,
  rechargeBattery: `*Nos preguntaste las Pilas Recargables por USB*
  ──────────────────
  *Principales características* 🧏🏽
  ...
  *Presentaciones*
  ...
  ·٠•● 5 niveles de brillo
  ·٠•● Alfombrilla antideslizante
  ·٠•● Temporizador
  ──────────────────
  Características TÉCNICAS📲
  ·٠•● Giro horizontal 160 grados
  ·٠•● Se puede plegar y estirar en 225 grados
  ·٠•● Puerto de carga USB
  ──────────────────
  Disponibilidad 🎨
  ◉ color: Plomo
  ◉ *Precio: Bs. 180*`,
  ...
  Principales características 🧏🏽‍♂️
  ·٠•● Ligera y compacta
  ·٠•● Altavoces incorporados
  ·٠•● Distancia de proyección recomendada 2 metros (60 pulgadas)
  ·٠•● Recomendado para ver películas y videos
  ──────────────────
  Características TÉCNICAS🛠️
  ·٠•● Interfaz compatible con USB/RCA/HDMI/SD
  ·٠•● Tamaño: 12.7 cm x 8 cm  x 4.5 cm
  ·٠•● Brillo 400-800 lúmenes,
  ...
  ·٠•● Controla desde la App
  ·٠•● Temperatura de color ajustable
  ·٠•● Altavoz Bluetooth integrado
  ──────────────────
  Características TÉCNICAS🛠️
  ·٠•● Amplio ángulo de haz (120°)
  ·٠•● Tamaño: 16.6 cm x 16.6 cm x 13 cm
  ...
  * Resistente al agua y al polvo
  ...
  helicopter: `*Nos preguntaste por el Helicoptero a control remoto*
  ──────────────
  *Principales características*
  -Diseño Compacto
  -Luces LED Nocturnas
  -Fácil manejo
  -Diferentes modos de velocidad
  ──────────────
  *Características técnicas*
  -Medidas 20cm de largo X 11cm de alto
  -El helicoptero cuenta con bateria interna (carga via USB)
  -El control requiere 2 pilas AA
  -.Carga rápida
  ──────────────
  Disponible en colores:
  🔵azul  y 🔴rojo
  *Precio Bs. 139* `,
  barrasLedRgb: `Nos preguntaste por las Barras RGB💡
  ──────────────────
  *Principales características* 🧏🏽‍♂️
  ·٠•●Cada set incluye 2 unidades de luces LED.
  ·٠•● Se mueven al ritmo del sonido
  ·٠•● Compatibles con los asistentes Google Home y Alexa, controla con tu voz.
  ──────────────────
  Características TÉCNICAS📲
  ·٠•● Conexión vía USB
  ·٠•● Control total desde el mando y la App para ajustar brillo y velocidad.
  ·٠•● Tamaño: 26 cm de alto y 4 cm de ancho.
  ──────────────────
  Disponibilidad 🎨
  ◉ color: Negro
  ◉  *~Precio Bs. 250~
  *Precio de oferta: Bs. 199*`,
  skmmanijaroja: `*Nos preguntaste por el _Reloj Skmei Correa Metálica_*⌚
  ──────────────────
  *Principales características*🔅
  ·٠•● Correa de Metálica ajustable
  ·٠•● Diseño elegante de números
  ·٠•● Borde metálico
  ──────────────────
  *Características TÉCNICAS*📲
  ·٠•● Utiliza pilas de reloj genéricas
  ·٠•● Correa de 20mm
  ·٠•● Material inoxidable
  ·──────────────────
  *Disponibilidad* 🎨
   *Precio bs. 200 * `,
